...
| 🖥️ **Полноэкранный UI** | Перекрытие всех окон с кастомным курсором (пиратский флаг) |
...
| ⚙️ **System Monitor** | Real-time отображение CPU/RAM через `psutil` |
...
```
Educational Use Only — только для образовательных целей
и тестирования систем защиты информации.
```
...
**Created for Cybersecurity Research 🛡️**
